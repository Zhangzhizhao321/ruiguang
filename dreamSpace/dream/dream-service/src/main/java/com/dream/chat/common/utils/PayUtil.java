...
public class PayUtil {
     ...
     * @return
     */
    public static Map<String, String> submitOrderH5WX4j(String id, BigDecimal amount, String ip, String notify, String subject, String openId, String clientType/*,Integer flag*/,String affairId) throws WeixinException, SDKRuntimeException {
        UnifiedOrder unifiedOrder = WeixinPayUtil.getUnifiedOrder(openId, id, ip,
                amount, subject,notify,clientType,affairId/*,flag.toString()*/);
