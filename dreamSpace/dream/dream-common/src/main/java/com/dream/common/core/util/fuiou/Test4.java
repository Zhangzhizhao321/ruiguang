...
public class Test4 {
	...
	public static void main(String[] args){
	    try {
	        ...
	        String busiCd ="AC01" ;
	        String credtTp = "0";
	        String acntNo ="6217920102754475";
	        String bankCd ="0310";
	        String userNm = "王涛";
	        String credtNo ="34032219900102421x";
	        String srcChnl ="DSF";
	        String acntTp = "01";
	        String mobileNo ="15216780162";
	        String mchntCd ="0002900F0345142";
	        String reserved1 ="test1";
	        ...
	        String loginUrl = "https://fht-test.fuiou.com/fuMer/api_contract.do";
